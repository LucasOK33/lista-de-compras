...
A Lista de Compras permite que os alunos organizem os produtos da Lojinha Sistematica que desejam adquirir.

Ao utilizar a lista, o usuário pode:

- Adicionar os produtos que deseja comprar;
- Visualizar os produtos adicionados;
- Marcar os produtos que já foram comprados;
- Remover produtos que não deseja mais adquirir;
- Manter a lista organizada durante o processo de compra.
...
A Lojinha Sistematica reúne produtos personalizados para os alunos que desejam representar a identidade dos cursos de Tecnologia da Informação da UNIFRAN.



Entre os produtos disponíveis, existem opções para diferentes estilos e ocasiões, permitindo que cada aluno escolha os itens que mais combinam com suas preferências.
